...
CREATE DATABASE IF NOT EXISTS qooerp_monitor
...
CREATE USER IF NOT EXISTS 'qooerp_monitor'@'%' IDENTIFIED BY 'qooerp_monitor_2026';
GRANT SELECT, INSERT, UPDATE, DELETE ON qooerp_monitor.* TO 'qooerp_monitor'@'%';
FLUSH PRIVILEGES;
