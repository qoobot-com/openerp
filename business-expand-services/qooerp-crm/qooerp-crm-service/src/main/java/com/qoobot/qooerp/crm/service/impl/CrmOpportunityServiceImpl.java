...
public class CrmOpportunityServiceImpl implements CrmOpportunityService {
    ...
    @Override
    public IPage<CrmOpportunityDTO> listOpportunities(PageQueryDTO pageParam, Long customerId, Integer stage, Integer status, Long ownerId) {
        pageParam.checkAndSetDefault();
        Page<CrmOpportunity> page = pageParam.toPage();
