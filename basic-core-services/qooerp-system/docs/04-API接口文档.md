...
| 2.0.0 | 2026-02-18 | 补充系统公告、在线用户、数据导入导出、审计日志等接口 | Auto |
| 2.1.0 | 2026-02-18 | 移除文件管理接口 | Auto |
| 2.2.0 | 2026-02-18 | 移除定时任务接口 | Auto |
| 2.3.0 | 2026-02-18 | 更新模块依赖关系，明确与其他模块为并列微服务，通过Feign客户端调用 | Auto |
