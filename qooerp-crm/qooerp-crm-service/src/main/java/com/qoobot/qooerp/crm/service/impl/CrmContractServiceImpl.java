...
public class CrmContractServiceImpl implements CrmContractService {
    ...
    @Override
    public IPage<CrmContractDTO> listContracts(PageParam pageParam, Long customerId, Integer status) {
        Page<CrmContract> page = new Page<>(pageParam.getPage(), pageParam.getSize());
